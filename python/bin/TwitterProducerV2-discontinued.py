...
#"https://api.twitter.com/2/tweets?ids=1460323737035677698%2C1460323743339741184%2C1460323746120540165&tweet.fields=author_id&expansions=attachments.poll_ids"
...
lastTime = time.time() #milliseconds

responseArray=[]


#"https://api.twitter.com/2/tweets?ids=1460323737035677698%2C1460323743339741184%2C1460323746120540165&place.fields=country"
...
for response_line in response.iter_lines():
    if response_line:
        ...
        #tmp.replace("@","")
        responseArray.append(json_response)
        print(time.time())
        if(time.time()-lastTime>1):
            ...
            for i in range(n-1, -1, -1):
                json_response=responseArray.pop(i)
